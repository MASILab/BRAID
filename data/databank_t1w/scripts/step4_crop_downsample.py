    ...
    for root, dirs, files in os.walk(root_dir):
        for fn in files:
            if fn.endswith(suffix):
                list_t1w_mni152.append(os.path.join(root, fn))
    
    print(f'Found {len(list_t1w_mni152)} T1w images in MNI152 space for {root_dir}')            
    return list_t1w_mni152
...
if __name__ == "__main__":
    ...
    for dataset_dir in list_datasets:
        ...
        list_t1w_mni152 = list_t1w_mni152(
