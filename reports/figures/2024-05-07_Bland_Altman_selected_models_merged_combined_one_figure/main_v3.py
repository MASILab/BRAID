...
if __name__ == '__main__':
    ...
    for t in cnstar_threshold_choices:
        bland_altman.plot_bland_altman(df, t, f'reports/figures/2024-05-07_Bland_Altman_selected_models_merged_combined_one_figure/figs/v3/brain_age_models_bland_altman_cnstar-{t}.png')