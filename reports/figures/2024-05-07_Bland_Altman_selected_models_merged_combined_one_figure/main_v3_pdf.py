...
class BlandAltman:
    ...
    def plot_bland_altman(self, df, cnstar_threshold, pdf):
        # hyperparameters
        fontsize = 8.5
        ...
        for model_name, model_dict in self.dict_models.items():
            ...
            ax.text(0.5, 0.025, fr'$\overline{{|BAG|}}$ = {mae:.2f}', fontsize=fontsize, fontfamily=fontfamily, transform=ax.transAxes,
                    ha='center', va='bottom')
...
if __name__ == '__main__':
    ...
    for t in cnstar_threshold_choices:
        bland_altman.plot_bland_altman(df, t, f'reports/figures/2024-05-07_Bland_Altman_selected_models_merged_combined_one_figure/figs/v3_pdf/brain_age_models_bland_altman_cnstar-{t}.pdf')