"""
Test whether we can get uniformly distributed ages using the dataloader,
and whether all scans can be sampled eventually.
...
for i in tqdm(range(epochs)):
    ...
    if (i+1) in milestones:
        ...
        fig.savefig(f'experiments/2023-12-13_Test_DataLoader/figs/epoch-{i+1}.png', bbox_inches='tight')
        plt.close('all')